...
def test_internal_custom_loss_functions(mc):
    ...
    mc.add_internal_custom_loss(removed_name, removed_power_loss_function, removed_type, removed_thermal_node)
...
def test_external_custom_loss_functions(mc):
    ...
    mc.add_external_custom_loss(removed_name, removed_power_loss_function, removed_voltage_drop_function)
