...
There are several standalone functions that can be utilised for various purposes, such as providing errors, setting the
Motor-CAD directory and the IP address. For descriptions of these functions, see :ref:`ref_Utility_Functions`.
