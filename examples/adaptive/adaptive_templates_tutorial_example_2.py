...
mc.load_adaptive_script(os.path.join(working_folder, "adaptive_template_script_files/Adaptive_Templates_Example_2.py"))

# %%
# The script that was loaded in is shown below:
#
# Adaptive_Templates_Example_2.py script file
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
# %%
# As well as the ``geometry`` library used by the script that was loaded into Motor-CAD previously
...
#
# Open the file that was saved earlier

mc.load_from_file(os.path.join(working_folder, mot_name + ".mot"))
...
# %%
# Instead of loading a script into Motor-CAD, as done previously,
# the following debug script is run externally.
# The following script is very similar to that loaded in previously,
# but contains the debugging feature to draw the geometry regions.
#
