...
class _RpcMethodsCore:
    ...
    def get_array_variable_2d(self, array_name, array_index1, array_index2):
        ...
        return self.mc_connection.send_and_receive(method, params)
    ...
    def restore_compatibility_settings(self):
        ...
        return self.mc_connection.send_and_receive(method)
    ...
    def set_visible(self, visible):
        ...
        """
        if version.parse(self.mc_connection.program_version) < version.parse("15.2.0"):
    ...
    def get_im_sat_factor(self, i_mag):
        ...
        params = [i_mag]
        return self.mc_connection.send_and_receive(method, params, success_var=False)
    ...
    def get_node_exists(self, node_number):
        ...
        params = [node_number]
        node_exists = self.mc_connection.send_and_receive(method, params, success_var=False)
        return node_exists
